...
import ExpenseEdit from "../../components/Forms/ExpenseEdit";
import BannerEdit from "../../components/Forms/BannerEdit";
    ...
    <Row style={{ justifyContent: "space-evenly" }}>
      <Col lg={2} md={3} className="hide-sm">
        <ListGroup>
          ...
          <Link to="/admin/admin-panel/banner">
            <ListGroup.Item className="rounded" active={view === "banner"}>
              Banner
            </ListGroup.Item>
          </Link>
          ...
          <Link to="/admin/admin-panel/expenses">
            <ListGroup.Item className="rounded" active={view === "expenses"}>
              Expenses
            </ListGroup.Item>
          </Link>
      ...
      >
        ...
        {view === "banner" && <BannerEdit history={history} />}
        {view === "orders" && (
          <OrderListScreen
            keyword={keyword}
            pageNumber={pageNumber}
